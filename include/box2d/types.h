...
/// Notes:
/// - this function is called on the thread that invokes b2World_Step
/// - this is only called if the shape has enabled pre-solve events
///   or world-wide pre-solve events are enabled
/// - this is called only for awake dynamic bodies
/// - this is not called for sensors
/// - separation is the deepest manifold separation in length units; it is zero for CCD time-of-impact callbacks
/// Return false if you want to disable the contact this step
/// @warning Do not structurally modify the world inside this callback. The
/// world-wide pre-solve event flag may be changed.
/// @ingroup world
typedef bool b2PreSolveFcn( b2ShapeId shapeIdA, b2ShapeId shapeIdB, b2Vec2 point, b2Vec2 normal, float separation,
							void* context );
